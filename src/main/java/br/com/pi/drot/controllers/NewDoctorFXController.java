...
public class NewDoctorFXController extends SideBarController implements Initializable {
    ...
    @FXML
    void btnSwitchNewDoctorScreen(ActionEvent event) {
	...
	void cadastrarMedico(ActionEvent event) {
		if (this.nome.getText().equals("") || this.cpf.getText().equals("") || this.rg.getText().equals("") || this.dataNascimento.getText().equals("") || this.rua.getText().equals("") || this.numero.getText().equals("") || this.bairro.getText().equals("") || this.cidade.getText().equals("") || this.cep.getText().equals("") || this.email.getText().equals("") || this.senha.getText().equals("") || this.uf.getText().equals("")) {
			...
			if (!CpfValidation.cpfValido(FormatadorCPF.cleanCpf(this.cpf.getText()))) {
				...
				if (idEnderecoExistente != -1) {
					...
					this.limparFormularioCadastroMedico();
				} else {
	...
	public void limparFormularioCadastroMedico() {
		JOptionPane.showMessageDialog(null, "New Doctor adding with success!", "Doctor add with success", 0);
